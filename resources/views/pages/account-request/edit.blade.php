                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" inputmode="numeric" name="nik" id="nik" class="form-control @error('nik')
                                is-invalid @enderror" value="{{ old('nik', $resident->nik) }}">
                                @error('nik')
                        ...
                        <div class="form-group mb-3">
                            <label for="birth_date">Taggal Lahir</label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea  name="address" cols="30" rows="10" id="address" class="form-control @error('address')
